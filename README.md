...
<p align="center">
  ...
  <i>Construindo agentes de IA e plataformas de dados que aguentam produção.</i>
</p>
...
- **Código continua sendo um ativo crítico**, mesmo quando quem escreve é a IA.
- **Fundamentos de Software Engineering** (DDD, TDD, SDD, bounded context) ficaram **mais relevantes**, não menos, na era dos agentes.

Não acredito em "melhor cloud" nem em "melhor linguagem". Acredito em escolher bem para o contexto e em **executar com qualidade**.
...
|---|---|---|
| **2025 — hoje** | AI Engineer | Belake.ai · Dataside |
